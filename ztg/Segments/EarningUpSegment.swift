...
protocol earningUpSegmentDelegate : class {
    
    func earnButtonDidClicked()
    
}

class EarningUpSegment: UIView {
    
    weak var delegate : earningUpSegmentDelegate?
    
    lazy var image: UIImageView = {
        
        let temp = UIImageView()
        temp.image = UIImage(named:"ic_profit_yi.png")
        return temp
    ...
    override init(frame: CGRect) {
        ...
        self.earnButton.addTarget(self, action: #selector(earnButtonClicked), forControlEvents: .TouchUpInside)
    ...
    func earnButtonClicked(){
        
        self.delegate?.earnButtonDidClicked()
